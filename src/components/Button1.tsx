...
export default function Button1 ({
    ...
    return (
        <PrismicNextLink 
            field={linkField}
            className={clsx( "group relative flex w-fit text-white-800 items-center justify-center overflow-hidden rounded-md px-4 py-2 font-bold transition-transform ease-out hover:scale-105",
            className)}
        >
            {/* <span 
                className={clsx(
