...
export default function ContentList({
  ...
  const contentImages = items.map((item) => {
    const image = isFilled.image(item.data.hover_image)
      ...
      : fallbackItemImage;
    return asImageSrc(image, { width: 1220, height: 320});
  });
    ...
    <>
      ...
      >
        {items.map((post, index) => (
          ...
          >
            <a
              ...
              border-t-slate-100 
              py-10  text-slate-200 md:flex-row "
        ...
        <div
          ...
          -z-10 h-[320px] w-[220px] rounded-lg bg-cover bg-center opacity-0 transition-[background] duration-300"
          style={{
            backgroundImage:
